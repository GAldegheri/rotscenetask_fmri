...
if __name__=="__main__":
    ...
    univar_df = load_univar_by_voxelno(args.sub, roi, 'test', 29, voxelnos)
    univar_df.to_csv(f'/project/3018040.05/Univar_results/test_m29/{args.sub}_ba-17-18.csv', index=False)